...
curl --request POST http://10.43.52.207:5000/api/timeline_post -d "name=$name&email=$email&content=$content"

curl http://10.43.52.207:5000/api/timeline_post | grep "$name" | grep "$email" | grep "$content"
